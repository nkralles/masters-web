...
func UnaryServerInterceptor(l *Logger, logFunc func(ctx context.Context) map[string]interface{}, ignoreMethods ...string) grpc.UnaryServerInterceptor {
...
func StreamServerInterceptor(l *Logger, logFunc func(ctx context.Context) map[string]interface{}, ignoreMethods ...string) grpc.StreamServerInterceptor {
...
func UnaryClientInterceptor(l *Logger, logFunc func(ctx context.Context) map[string]interface{}, ignoreMethods ...string) grpc.UnaryClientInterceptor {
...
func StreamClientInterceptor(l *Logger, logFunc func(ctx context.Context) map[string]interface{}, ignoreMethods ...string) grpc.StreamClientInterceptor {
